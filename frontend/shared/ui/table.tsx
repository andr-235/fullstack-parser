...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn('px-4 py-2 font-bold text-slate-300 border-r border-slate-700 last:border-r-0', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('px-4 py-2 border-r border-slate-700 last:border-r-0', className)}
    {...props}
  />
))
