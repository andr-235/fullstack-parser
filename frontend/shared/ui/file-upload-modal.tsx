...
export function FileUploadModal({
 ...
 const defaultDescriptions = {
  groups: 'Поддерживаемые форматы: CSV (screen_name,name,description) или TXT (одно screen_name на строку)',
  keywords: 'Поддерживаемые форматы: CSV (word,category,description) или TXT (одно слово на строку)',
 }
