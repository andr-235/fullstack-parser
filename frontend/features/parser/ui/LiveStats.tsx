        ...
        <Card className="relative overflow-hidden">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div
                className={`p-2 rounded-lg ${animatedValues.successRate >= 80 ? 'bg-green-100 dark:bg-green-900/20' : animatedValues.successRate >= 50 ? 'bg-orange-100 dark:bg-orange-900/20' : 'bg-red-100 dark:bg-red-900/20'}`}
              >
                <Target
                  className={`h-5 w-5 ${animatedValues.successRate >= 80 ? 'text-green-600 dark:text-green-400' : animatedValues.successRate >= 50 ? 'text-orange-600 dark:text-orange-400' : 'text-red-600 dark:text-red-400'}`}
                />
              </div>
            </div>
            {animatedValues.successRate >= 80 ? (
              <Badge
                variant="secondary"
                className="mt-2 text-xs bg-green-100 text-green-700 dark:bg-green-900/20 dark:text-green-400"
              >
                Отлично
              </Badge>
              ...
              <Badge
                variant="secondary"
                className="mt-2 text-xs bg-orange-100 text-orange-700 dark:bg-orange-900/20 dark:text-orange-400"
              >
                Хорошо
              </Badge>
            ) : (
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                  ...
                  <XAxis dataKey="name" fontSize={12} className="text-muted-foreground" />
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={trendData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                <CartesianGrid strokeDasharray="3 3" className="opacity-30" />
                <XAxis dataKey="time" fontSize={12} className="text-muted-foreground" />
                <YAxis fontSize={12} className="text-muted-foreground" />
                <Tooltip
                  contentStyle={{
                    backgroundColor: 'hsl(var(--background))',
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">
                  0<span className="text-sm text-muted-foreground ml-1">/ 0</span>
                </p>
              </div>
            </div>
          </CardContent>
