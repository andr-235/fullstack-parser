        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <Label htmlFor="parse-all-modal" className="text-sm">
                  Все группы
                </Label>
                <Switch
                  id="parse-all-modal"
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger>
                  <SelectValue
                    placeholder={parseAllGroups ? 'Все активные группы' : 'Выберите группу'}
                  />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">Рекомендуется: 50-200 постов</p>
            </div>

            <div className="space-y-2">
              <Label htmlFor="force-reparse-modal" className="text-base font-medium">
