...
import { Clock, Zap, FileText, Users, TrendingUp, Activity } from 'lucide-react'
...
export function ParserProgress({ state, isRunning }: ParserProgressProps) {
  ...
  }, [state?.overall_progress, animatedProgress])
  ...
  const calculateSpeed = () => {
    ...
    return Math.round(state.total_posts_found / timeInMinutes)
  }
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 bg-muted/50 rounded-lg border">
              ...
              <p className="text-sm text-muted-foreground">
                Парсер готов к запуску. Выберите группы для парсинга и нажмите кнопку
                &quot;Запустить парсер&quot;.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-2 p-3 bg-muted/50 rounded-lg border">
            ...
            <div>
              ...
              <p className="text-lg font-bold">{state?.total_posts_found || 0}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 p-3 bg-muted/50 rounded-lg border">
            ...
            <div>
              ...
              <p className="text-lg font-bold">{speed} постов/мин</p>
            </div>
          </div>
        </div>
