   ...
   <CardContent>
    <div className="space-y-3">
     {recentComments.map((comment) => {
      ...
      return (
       <div key={comment.id} className="flex items-start gap-3 p-3 rounded-lg border hover:bg-muted/30 transition-colors">
        ...
        <Button variant="ghost" size="sm" className="flex-shrink-0 opacity-0 group-hover:opacity-100">
