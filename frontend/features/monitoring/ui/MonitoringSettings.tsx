...
export default function MonitoringSettings({
 ...
 const [intervalMinutes, setIntervalMinutes] = useState(group.monitoring_interval_minutes);
    ...
    <div className="space-y-6">
     ...
     <div className="flex items-center justify-between">
      <div className="space-y-0.5">
       <Label className="text-sm font-medium">Автоматический мониторинг</Label>
     ...
     <div className="space-y-2">
      ...
      <div className="grid grid-cols-2 gap-4 text-sm">
       <div>
        ...
        <span className="ml-2 font-medium">{group.monitoring_runs_count}</span>
       </div>
       <div>
        <span className="text-slate-400">Последний успех:</span>
        <span className="ml-2 font-medium">
         {group.last_monitoring_success
          ? new Date(group.last_monitoring_success).toLocaleDateString('ru-RU')
          : 'Нет'
         }
        </span>
       </div>
