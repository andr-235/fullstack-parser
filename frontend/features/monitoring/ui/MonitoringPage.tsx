    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Мониторинг системы и проверка работоспособности</p>
        </div>
      ...
      {/* Filters */}
      <MonitoringFilters filters={filters} onFiltersChange={setFilters} />
      ...
      {/* Recent Activity */}
      <MonitoringList events={mockEvents} loading={isRefreshing} />
    </div>
  )
}
