...
export function CommentsFilters({
  ...
  const handleAddSpecialAuthor = (authorScreenName: string) => {
    if (!filters.authorScreenName.includes(authorScreenName)) {
      handleFilterChange('authorScreenName', [
        ...filters.authorScreenName,
        authorScreenName,
      ])
    }
  }
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              handleFilterChange('groupId', value ? parseInt(value) : null)
            }
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              handleFilterChange('keywordId', value ? parseInt(value) : null)
            }
          >
            <SelectTrigger>
