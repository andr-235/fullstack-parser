...
export function CommentsBulkActions({
 ...
 const isAllSelected = selectedComments.length === totalComments && totalComments > 0
 const isPartiallySelected = selectedComments.length > 0 && selectedComments.length < totalComments
   ...
   <div className="flex items-center gap-4">
    ...
    <div className="flex items-center gap-2">
     ...
     <span className="text-sm text-slate-400">
      {hasSelected ? `${selectedComments.length} из ${totalComments}` : 'Выбрать все'}
     </span>
    </div>
