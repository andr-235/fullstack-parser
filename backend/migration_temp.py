...
Revision ID: 1224e4923ebb
Revises: 05f77fc9bc66
Create Date: 2025-08-27 18:06:24.073728
...
def upgrade() -> None:
    ...
    op.add_column("keywords", sa.Column("is_case_sensitive", sa.Boolean, nullable=False, server_default="false"))
    op.add_column("keywords", sa.Column("is_whole_word", sa.Boolean, nullable=False, server_default="false"))
    op.add_column("keywords", sa.Column("total_matches", sa.Integer, nullable=False, server_default="0"))
