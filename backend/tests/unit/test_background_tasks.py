...
class TestBackgroundTaskManager:
    ...
    async def test_get_task(self, task_manager, mock_func):
        ...
        task_id = await task_manager.submit_task(func=mock_func, name="test_task")
    ...
    async def test_task_execution_success(self, task_manager):
        ...
        task_id = await task_manager.submit_task(func=test_func, name="test_task")
    ...
    async def test_task_execution_error(self, task_manager):
        ...
        task_id = await task_manager.submit_task(func=error_func, name="error_task")
    ...
    async def test_sync_function_execution(self, task_manager):
        ...
        task_id = await task_manager.submit_task(func=sync_func, name="sync_task")
...
class TestBackgroundTaskFunctions:
    ...
    async def test_submit_background_task(self, mock_task_manager):
        ...
        with patch('app.core.background_tasks.background_task_manager', mock_task_manager):
    ...
    async def test_get_background_task_status(self, mock_task_manager):
        ...
        with patch('app.core.background_tasks.background_task_manager', mock_task_manager):
            ...
            mock_task_manager.get_task_status.assert_called_once_with("test_task_id")
    ...
    async def test_get_background_task_result(self, mock_task_manager):
        ...
        with patch('app.core.background_tasks.background_task_manager', mock_task_manager):
            ...
            mock_task_manager.get_task_result.assert_called_once_with("test_task_id") 