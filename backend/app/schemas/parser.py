...
class ParseTaskCreate(BaseModel):
    ...
    force_reparse: bool = Field(default=False, description="Принудительно перепарсить уже обработанные посты")
...
class ParseStats(BaseModel):
    ...
    comments_with_keywords: int = Field(default=0, description="Комментариев с ключевыми словами")
    ...
    duration_seconds: Optional[float] = Field(None, description="Продолжительность в секундах")
