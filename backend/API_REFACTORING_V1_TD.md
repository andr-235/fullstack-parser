...
### Этап 7: DDD Архитектура (2-3 дня)

- [x] Создать Domain слой с сущностями (Comment, VKGroup, Keyword)
- [x] Создать Application слой с сервисами
...
- [ ] Протестировать DDD архитектуру
- [ ] Оптимизировать производительность Domain объектов
...
| **Создано файлов**      | 13 новых компонентов + DDD слои         |
